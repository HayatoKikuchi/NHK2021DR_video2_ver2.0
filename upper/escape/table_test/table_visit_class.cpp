...
void table_visit_class::calc_angle_status(double aim_table_angle, double calc_angle){//1つ前の処理と現在の処理でaim_table_angleが一致しないとtime_countが0になって加速度計算から始まる
    double rate;//基準との比
    ...
    //int data = (int)(sin_angle_2 * 10000);
    //sin_angle = sqrt(data) / 100;
    //float tan_angle = sin_angle / cos_angle;
    //double tan_angle_2 = sin_angle_2 / cos_angle_2;
    //double arcsin = asin(sin_angle);
//    int tab = (int)multi;
